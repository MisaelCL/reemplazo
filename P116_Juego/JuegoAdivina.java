...
public class JuegoAdivina implements Juego{
    ...
    public void jugar() {
        int num = 0;
        do {
            System.out.println("Dame numero entre 1 y 100: "); num = new Scanner(System.in).nextInt();
    ...
    public void finalizar() {
        System.out.println(this.num + "Era el numero !!!!. ganaste despues de " + intentos + "intentos !");        
    }
