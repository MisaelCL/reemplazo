...
public class App extends JFrame implements ActionListener{
    ...
    public App() {
        ...
        jdlAcercaDe.setSize(500, 450);
        jdlAcercaDe.setLocationRelativeTo(null);
        lblDatos = new JLabel("<html>Programación Oriendada a Objetos I<br>Misael Campo Loera</html>",
                JLabel.CENTER);
        ...
        pnlDatos = new JPanel();
        add(pnlDatos);
        pnlDatos.setLayout(new GridLayout(6, 2));
    ...
    public void guardarCampos() {
        ...
        if (sexo.length() == 1) {
            est.setSexo(sexo.charAt(0));
        } else {
            JOptionPane.showMessageDialog(this, "El sexo debe ser un solo carácter.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        //est.setSexo(Character.parseChar(txtSexo.getText()));
        //est.setEstadoCivil(txtEstadoCivil.getText());
        //est.setDescripcion(txtDescripcion.getText());
        //est.setSalario(Double.parseDouble(txtSalario.getText()));
        //datos.add(est);
