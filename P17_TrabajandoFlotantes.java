...
public class P17_TrabajandoFlotantes{
    public static void main(String[] args) {
        ...
        System.out.println(String.format("num1 y num2 en formateo flotante               :%f%f",num1,num2));
        System.out.println(String.format("num1 y num2 en formateo flotante con decimales :%.2f%.3f",num1,num2));
        System.out.println(String.format("num1 alineado en formato alineado              :%10.2f",num1));
        System.out.println(String.format("num2 alineado en formato alineado              :%10.2f",num2));
